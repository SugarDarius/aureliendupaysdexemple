...
const Glass = ({
  ...
  <motion.svg
    className={cn(
      'pointer-events-none fixed inset-0 rounded-full border-2 bg-[hsl(210_80%_90%/0.05)]',
    ...
    exit={{ opacity: 0 }}
    style={{ height: `${GLASS_SIZE}px`, width: `${GLASS_SIZE}px`, x, y }}
  >
    <path
...
const MagnifyFilter = () => (
  <svg
    ...
    xmlns='http://www.w3.org/2000/svg'
    style={{ height: `${GLASS_SIZE}px`, width: `${GLASS_SIZE}px` }}
  >
    <defs>
      <filter
        id='magnify-filter'
