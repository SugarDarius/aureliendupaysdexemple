...
- **Body Validation**: The `body` schema is defined using a validation library (in this case, [decoders](https://decoders.cc/)). Anzen handles parsing and validation, ensuring that the `body` parameter in the handler is correctly typed.
